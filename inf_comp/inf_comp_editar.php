...
$id = $_GET['id'];
$stmt2 = $auth_user->runQuery("SELECT * FROM ncm WHERE ncm_id =:id");
                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="ncm_id" name="ncm_id"  value="<?php echo $lista['ncm_id']; ?>" class="col-xs-3 col-sm-2"/>                               
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="ncm_codigo"  name="ncm_codigo" value="<?php echo $lista['ncm_codigo']; ?>"  class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="ncm_nome"  name="ncm_nome" value="<?php echo $lista['ncm_nome']; ?>"  class="form-control" />
                            </div>
                        </div>
