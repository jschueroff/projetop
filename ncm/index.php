                    ...
                    <div class="form-group">
                        <div class="row">
                            <form class="form-horizontal" method="post">                            
                                <div class="col-xs-7">
                                    <input type="text" id="ncm_id" name="ncm_pesquisa" class="col-xs-6" placeholder="NCM ou Descrição"/>
                                ...
                                <table id="simple-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <form method="post" id="login-form">
                                            <tr>
                                                <td><?php echo $row['ncm_id']; ?></td>
                                                <td class="hidden-480"><?php echo $row['ncm_codigo']; ?></td>

                                                <td class="hidden-480"><?php echo $row['ncm_nome']; ?></td>
                                                ...
                                                <td class="hidden-480" align="center">
                                                    <div class="form-group">
                                                        <button class="btn btn-white btn-info btn-bold" name="btn-editar" type="submit">
                                                            ...
                                                            <input type="hidden" name="ncm_id" value="<?php echo $valor[$id]; ?>">
                                                            Editar
                                                        </button>
                                                    </div>
                                                </td>
