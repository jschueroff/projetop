                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <form class="form-horizontal" method="post">
                                <div class="col-sm-10">
                                    <input type="text" id="funcionario_id" name="funcionario_pesquisa" class="col-xs-3 col-sm-9" placeholder="Nome ou E-mail"/>
                                    <button class="btn btn-white btn-info btn-bold" name="btn-pesquisar" type="submit">
                                ...
                                <table id="simple-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            $valor[$id] = $row['funcionario_id'];
                                            ?>
                                        <form method="post" id="login-form">
                                            <tr>
                                                <td><?php echo $row['funcionario_id']; ?></td>
                                                <td class="hidden-480"><?php echo $row['funcionario_nome']; ?></td>
                                                <td class="hidden-480"><?php echo $row['funcionario_email']; ?></td>
                                                <td class="hidden-480"><?php echo $row['funcionario_cidade']; ?></td>
                                                ...
                                                <td class="hidden-480" align="center">
                                                    <div class="form-group">
                                                        <button class="btn btn-white btn-info btn-bold" name="btn-editar" type="submit">
                                                            ...
                                                            <input type="hidden" name="funcionario_id" value="<?php echo $valor[$id]; ?>">
                                                            Editar
                                                        </button>
                                                    </div>
                                                </td>
