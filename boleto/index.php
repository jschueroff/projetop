                        ...
                        <div class="row">
                            ...
                            <p>
                                <a href="contas_receber_cadastro.php">
                                    <button class="btn btn-xs btn-alert" name="btn-cadastrar" type="submit">
                                ...
                                <table id="simple-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Emissão</th>
                                    ...
                                    <tbody>
                                        ...
                                        <form method="post" id="login-form">
                                            <tr>
                                                ...
                                                <td class="hidden-480"><?php echo date("d/m/Y", strtotime($row['contas_receber_data'])); ?></td>
