...
//$path_cert = '\pasta_do_certificado\\';
    $path_cert = 'C:/xampp/htdocs/alubrasc/certs/';
...
// Chave de acesso
//$chave_acesso = '42161118002167000157550010000000321050400708';
    $chave_acesso = $_GET['chave'];


    $arquivo = $downloadXml->downloadXmlSefaz($captcha, $chave_acesso, $CNPJ, $path_cert, $senha_cert);
